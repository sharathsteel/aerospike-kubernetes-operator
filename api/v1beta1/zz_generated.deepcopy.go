...
func (in *AerospikeClusterStatus) DeepCopyInto(out *AerospikeClusterStatus) {
	*out = *in
	...
	if in.UnhealthyRacks != nil {
		in, out := &in.UnhealthyRacks, &out.UnhealthyRacks
		*out = make([]UnhealthyRack, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnhealthyRack) DeepCopyInto(out *UnhealthyRack) {
	*out = *in
	in.LastRetriedTime.DeepCopyInto(&out.LastRetriedTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnhealthyRack.
func (in *UnhealthyRack) DeepCopy() *UnhealthyRack {
	if in == nil {
		return nil
	}
	out := new(UnhealthyRack)
	in.DeepCopyInto(out)
	return out
}
